...
const ui = StyleSheet.create({
  ...
  chartPlot: { height: 170, paddingHorizontal: caylikDesign.spacing.sm, paddingTop: caylikDesign.spacing.lg, flexDirection: 'row', alignItems: 'flex-end', justifyContent: 'space-between' },
  chartColumn: { flex: 1, minWidth: 0, alignItems: 'center' },
  chartTrack: { width: '48%', minWidth: 8, maxWidth: 18, height: 132, borderRadius: caylikDesign.radius.pill, justifyContent: 'flex-end', overflow: 'hidden' },
  chartBar: { width: '100%', borderRadius: caylikDesign.radius.pill },
  chartLabel: { marginTop: caylikDesign.spacing.xs, fontSize: 9, fontWeight: '800' },
